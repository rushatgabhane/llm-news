...
async def write_report_to_csv(all_articles):
    ...
    headers = ["Source", "Title", "Prompt", "Status", "Reason", "Retry", "MissingCategories", "Categories", "Insights", "Summary"]
        ...
        for entry in all_articles:
            try:
                ...
                row = [
                    ...
                    clean_for_csv(", ".join(metadata_info.get("missing_categories", [])), delimiter),
                    clean_for_csv(", ".join(response_info.get("categories", [])), delimiter),
                    clean_for_csv(", ".join(response_info.get("insights", [])), delimiter),
